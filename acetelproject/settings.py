"""
Django settings for acetelproject project.
...
#add the custom user authentication
...
ROOT_URLCONF = 'acetelproject.urls'
...
WSGI_APPLICATION = 'acetelproject.wsgi.application'
...
#media path for pictures or images
MEDIA_URL = 'media/'
